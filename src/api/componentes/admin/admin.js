...
import "bootstrap";
import FormularioNuevoUsuario from "../formularioNuevoUsuario/formularioNuevoUsuario";

// Estás inicializando el estado del componente admin con 3 propiedades: 
export default class admin extends React.Component{
        constructor(props){
            super(props);
            this.state = { usuario:""/*se inicializa como una cadena vacía*/,contrasenia:"", validacion:null, admin:false }
        }
    ...
    enviar(e){ // es un manejador de eventos 
          e.preventDefault() //Esta línea se utiliza para prevenir el comportamiento predeterminado del evento
          if(this.state.usuario == "" || this.state.contrasenia == ""){// verifica si los campos de usuario y contraseña están vacíos
          ...
          const datos = { // contiene la información del usuario y la contraseña obtenida del estado del componente React.
       ...
       <div className="container">
          ...
          <form> 
            <div class="form-floating mb-3">
              ...
              <input value={this.state.contrasenia}
